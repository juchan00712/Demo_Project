			...
			<li id="content">
				<ul>
					...
					<li>
						...
						<textarea disabled="disabled" style="background-color: #f7f7f7; font-size: inherit; border: none;
											resize: none;"><c:out value="${vo.content}"/></textarea>
		...
		<ul>
			...
			<li>
				<ul style="display: flex;flex-direction: column;">
					<li>
						<textarea rows="5" cols="90" name="content" style="resize:none;margin-right:20px;" 
...
<!-- 저장버튼 테스트를 위해 변경 --><c:if test="${sessionScope.user != null }">  <!-- 구현 완료 : 로그인 했을때 -->
			...
			<li>
				<textarea class="cmtcontent" style="boder: none; resize: none;"><c:out value="${cmt.content }" /></textarea>
			</li>
			</c:forEach>
		</ul>	
	</form>
...
<script type="text/javascript">
	...
	function login() {
		sessionStorage.setItem('back', location.href);		// location.href는 현재의 요청 url 읽어옵니다.
